...
<header class="bg-white border-b">
    <div class="container mx-auto flex justify-between items-center py-4">
        ...
        <nav id="menu" class="md:flex md:space-x-6 hidden md:block">
            <a href="login" class="hover:text-gray-600 px-4 py-2 font-semibold text-black">Home</a>
            <a href="login" class="hover:text-gray-600 px-4 py-2 font-semibold text-black">About Us</a>
            <a href="login" class="hover:text-gray-600 px-4 py-2 font-semibold text-black">Contact Us</a>
            <a href="login" class="hover:text-gray-600 px-4 py-2 font-semibold text-black">Login</a>
        </nav>
    </div>
